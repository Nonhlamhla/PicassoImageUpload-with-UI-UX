...
public class AccommodationAdmin extends AppCompatActivity {
...
//    List<Restaurant> restaurantList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accommodation_admin);

        databaseRestaurants = FirebaseDatabase.getInstance().getReference("accommodation");
...
//                startActivity(intent);
    ...
    private void AddRestaurant() {
        ...
        if (!TextUtils.isEmpty(name)) {
            ...
            StorageReference filePath = mStorageReference.child("AccommodationImages").child(uri.getLastPathSegment());
            filePath.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), AccommodationActivity.class);
                    startActivity(intent);
