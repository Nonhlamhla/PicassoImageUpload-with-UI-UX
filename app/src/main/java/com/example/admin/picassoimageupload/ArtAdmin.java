...
public class ArtAdmin extends AppCompatActivity {
...
//    List<Restaurant> restaurantList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_art_admin);

        databaseRestaurants = FirebaseDatabase.getInstance().getReference("art");
...
//                startActivity(intent);
    ...
    private void AddRestaurant() {
        ...
        if (!TextUtils.isEmpty(name)) {
            ...
            StorageReference filePath = mStorageReference.child("ArtImages").child(uri.getLastPathSegment());
